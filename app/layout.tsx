  ...
  return (
    <html lang="en" className={`${geist.variable} ${playfair.variable} scroll-smooth`}>
      <body className="min-h-screen bg-[#fdfcf8] text-[#0e2a1f] antialiased overflow-x-hidden">
        ...
        <FloatingActions />
        {/* Mobile Bottom CTA */}
        <div className="fixed bottom-0 left-0 right-0 z-40 flex gap-2 bg-white border-t border-stone-200 p-3 md:hidden shadow-[0_-8px_24px_rgba(0,0,0,0.08)]">
          <a href="tel:+919593069126" className="flex-1 flex items-center justify-center gap-2 bg-[#0e2e1f] text-white rounded-full py-3.5 font-semibold text-[15px] tracking-wide">
            <span className="text-lg">📞</span> Call
          </a>
          <a href="https://wa.me/919593069126?text=Hello%20Digital%20Agro%20Farming%20Services%2C%20I%20would%20like%20to%20know%20more%20about%20your%20agricultural%20services." target="_blank" className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white rounded-full py-3.5 font-semibold text-[15px]">
